...
- **API route-ok** (`src/app/api/*/route.ts`): validálják és visszaigazolják az örökbefogadási, önkéntes, ideiglenes befogadói, szállítói és kapcsolatfelvételi űrlapokat. Jelenleg nem írnak adatbázisba — ez a következő fejlesztési lépés helye (komment jelzi a kódban).
